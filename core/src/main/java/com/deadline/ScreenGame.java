    ...
    //            else if (roomY>0) shiftY-=roomSize/2f;
        ...
        private void vendingUiBatch() {
            if (actVending) {
                ...
                font.draw(batch, healCost + "", btnVendingBuyHeal.x + 4, btnVendingBuyHeal.y + 35);
                ...
                font.draw(batch, damageUpCost + "", btnVendingBuyDamageUp.x + 4, btnVendingBuyDamageUp.y + 35);
                ...
                font.draw(batch, speedUpCost + "", btnVendingBuySpeedUp.x + 4, btnVendingBuySpeedUp.y + 35);
                font.draw(batch, wallet + "", btnVendingBuyDamageUp.x + 4, btnVendingBuyDamageUp.y - 7);
            }
        }
